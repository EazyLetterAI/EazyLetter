...
export function EditUserInfo() {
  ...
  return (
    <div>
      ...
      <input type="text" placeholder="Firstname" value={userInfo?.firstname} className="bg-transparent text-black border border-black m-1.5" onChange={(e) => changeInfoState("firstname", e.target.value)} />
      <input type="text" placeholder="Middlename" value={userInfo?.middlename ?? ""} className="bg-transparent text-black border border-black m-1.5" onChange={(e) => changeInfoState("middlename", e.target.value)} />
      <input type="text" placeholder="Lastname" value={userInfo?.lastname} className="bg-transparent text-black border border-black m-1.5" onChange={(e) => changeInfoState("lastname", e.target.value)} />
      <input type="text" placeholder="Address" value={userInfo?.address ?? ""} className="bg-transparent text-black border border-black m-1.5" onChange={(e) => changeInfoState("address", e.target.value)} />
      <input type="text" placeholder="Phone" value={userInfo?.phone ?? ""} className="bg-transparent text-black border border-black m-1.5" onChange={(e) => changeInfoState("phone", e.target.value)} />
      ...
      {userEducation.map((education, index) => (
        <div key={index}>
          ...
          <input type="date" placeholder="End Date" value={formatDate(education.endDate)} className="bg-transparent text-black border border-black m-1.5" onChange={(e) => changeEducationInfo(index, "endDate", new Date(e.target.value))} />
          <input type="text" placeholder="GPA" value={education.gpa ?? ""} className="bg-transparent text-black border border-black m-1.5" onChange={(e) => changeEducationInfo(index, "gpa", e.target.value)} />
      ...
      {userExperiences.map((experience, index) => (
        <div key={index}>
          ...
          <input type="date" placeholder="Start Date" value={formatDate(experience.startDate)} className="bg-transparent text-black border border-black m-1.5" onChange={(event) => changeExperienceInfo(index, "startDate", new Date(event.target.value))} />
